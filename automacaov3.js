...
function AlteraRele14(){
    ...
    if(estado_14 === "0"){
		...
		document.getElementById("botao_14").innerHTML="<a href='/?14_desligar' class='botao_14'>Abrir</a>";
    } else {
        document.getElementById("estado_14").innerHTML="0";
        document.getElementById("rele_14").innerHTML="<div class='rele14_desligado'></div>";
        document.getElementById("botao_14").innerHTML="<a href='/?14_ligar' class='botao_14'>Abrir</a>";
    }
}